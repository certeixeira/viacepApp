...
package com.example.viacepapp.databinding;
...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnClear,
    ...
    this.btnFindCep = btnFindCep;
    this.etCep = etCep;
    this.imgViacep = imgViacep;
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.btnFindCep;
      Button btnFindCep = ViewBindings.findChildViewById(rootView, id);
      if (btnFindCep == null) {
        break missingId;
      }
      ...
      id = R.id.imgViacep;
      ImageView imgViacep = ViewBindings.findChildViewById(rootView, id);
      if (imgViacep == null) {
        break missingId;
      }
